    ...
    <footer className="grid gap-5">
      <div className='flex justify-between self-end max-md:grid max-md:gap-5'>
        <ul className="self-start space-y-1 text-p-s -mx-2 *:text-c1blue">
          ...
          <li><Link to="user/" className='py-1 px-2'>minha área.</Link></li>
        </ul>
        <div className="grid place-items-end gap-2 max-md:place-items-start">
          ...
          <ul className="flex gap-6">
            ...
            <li>
              <a href="https://drive.google.com/file/d/1qm2F27NJFXrfsoSqB2YS18DpjnFVCRMa/view?usp=sharing" target="_blank">
      ...
      <Link to='/' className='py-1 px-2 -mx-2 max-w-max text-p-l text-c2blue place-self-center'>raterate. {year}</Link>
    </footer>
  );
};
